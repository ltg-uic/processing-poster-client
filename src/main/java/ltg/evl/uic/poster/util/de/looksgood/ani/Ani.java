...
package ltg.evl.uic.poster.util.de.looksgood.ani;

import ltg.evl.uic.poster.util.de.looksgood.ani.easing.Easing;
...
public class Ani extends AniCore {
    ...
    public Ani(Object theTarget, float theDuration, String theFieldName, float theEnd) {
        super(papplet(), defaultAutostartMode, theTarget, theDuration, 0.0f, theFieldName, theEnd, defaultEasing,
              defaultTimeMode, theTarget, defaultCallback);
    }
    ...
    public Ani(Object theTarget, float theDuration, float theDelay, String theFieldName, float theEnd) {
        super(papplet(), defaultAutostartMode, theTarget, theDuration, theDelay, theFieldName, theEnd, defaultEasing,
              defaultTimeMode, theTarget, defaultCallback);
    }
    ...
    public Ani(Object theTarget, float theDuration, String theFieldName, float theEnd, Easing theEasing) {
        super(papplet(), defaultAutostartMode, theTarget, theDuration, 0.0f, theFieldName, theEnd, theEasing,
              defaultTimeMode, theTarget, defaultCallback);
    }
    ...
    public Ani(Object theTarget, float theDuration, float theDelay, String theFieldName, float theEnd,
               Easing theEasing) {
        super(papplet(), defaultAutostartMode, theTarget, theDuration, theDelay, theFieldName, theEnd, theEasing,
              defaultTimeMode, theTarget, defaultCallback);
    }
    ...
    public Ani(Object theTarget, float theDuration, String theFieldName, float theEnd, Easing theEasing,
               String theCallback) {
        super(papplet(), defaultAutostartMode, theTarget, theDuration, 0.0f, theFieldName, theEnd, theEasing,
              defaultTimeMode, theTarget, theCallback);
    }
     ...
     */
    public Ani(Object theTarget, float theDuration, float theDelay, String theFieldName, float theEnd, Easing theEasing,
               Object theCallbackObject, String theCallback) {
        super(papplet(), defaultAutostartMode, theTarget, theDuration, theDelay, theFieldName, theEnd, theEasing,
              defaultTimeMode, theCallbackObject, theCallback);
    }
    ...
    public static Ani to(Object theTarget, float theDuration, String theFieldName, float theEnd) {
        return addAni(false, theTarget, theDuration, 0.0f, theFieldName, theEnd, defaultEasing, defaultTimeMode,
                      theTarget, defaultCallback);
    }
    ...
    public static Ani from(Object theTarget, float theDuration, String theFieldName, float theEnd) {
        return addAni(true, theTarget, theDuration, 0.0f, theFieldName, theEnd, defaultEasing, defaultTimeMode,
                      theTarget, defaultCallback);
    }
    ...
    public static Ani to(Object theTarget, float theDuration, float theDelay, String theFieldName, float theEnd) {
        return addAni(false, theTarget, theDuration, theDelay, theFieldName, theEnd, defaultEasing, defaultTimeMode,
                      theTarget, defaultCallback);
    }
    ...
    public static Ani from(Object theTarget, float theDuration, float theDelay, String theFieldName, float theEnd) {
        return addAni(true, theTarget, theDuration, theDelay, theFieldName, theEnd, defaultEasing, defaultTimeMode,
                      theTarget, defaultCallback);
    }
    ...
    public static Ani to(Object theTarget, float theDuration, String theFieldName, float theEnd, Easing theEasing) {
        return addAni(false, theTarget, theDuration, 0.0f, theFieldName, theEnd, theEasing, defaultTimeMode, theTarget,
                      defaultCallback);
    }
    ...
    public static Ani from(Object theTarget, float theDuration, String theFieldName, float theEnd, Easing theEasing) {
        return addAni(true, theTarget, theDuration, 0.0f, theFieldName, theEnd, theEasing, defaultTimeMode, theTarget,
                      defaultCallback);
    }
    ...
    public static Ani to(Object theTarget, float theDuration, float theDelay, String theFieldName, float theEnd,
                         Easing theEasing) {
        return addAni(false, theTarget, theDuration, theDelay, theFieldName, theEnd, theEasing, defaultTimeMode,
                      theTarget, defaultCallback);
    }
    ...
    public static Ani from(Object theTarget, float theDuration, float theDelay, String theFieldName, float theEnd,
                           Easing theEasing) {
        return addAni(true, theTarget, theDuration, theDelay, theFieldName, theEnd, theEasing, defaultTimeMode,
                      theTarget, defaultCallback);
    }
    ...
    public static Ani to(Object theTarget, float theDuration, String theFieldName, float theEnd, Easing theEasing,
                         Object theCallbackObject, String theCallback) {
        return addAni(false, theTarget, theDuration, 0.0f, theFieldName, theEnd, theEasing, defaultTimeMode,
                      theCallbackObject, theCallback);
    }
    ...
    public static Ani from(Object theTarget, float theDuration, String theFieldName, float theEnd, Easing theEasing,
                           Object theCallbackObject, String theCallback) {
        return addAni(true, theTarget, theDuration, 0.0f, theFieldName, theEnd, theEasing, defaultTimeMode,
                      theCallbackObject, theCallback);
    }
     ...
     */
    public static Ani to(Object theTarget, float theDuration, float theDelay, String theFieldName, float theEnd,
                         Easing theEasing, String theCallback) {
        return addAni(false, theTarget, theDuration, theDelay, theFieldName, theEnd, theEasing, defaultTimeMode,
                      theTarget, theCallback);
    }
     ...
     */
    public static Ani to(Object theTarget, float theDuration, float theDelay, String theFieldName, float theEnd,
                         Easing theEasing, Object theCallbackObject, String theCallback) {
        return addAni(false, theTarget, theDuration, theDelay, theFieldName, theEnd, theEasing, defaultTimeMode,
                      theCallbackObject, theCallback);
    }
    ...
    public static Ani[] to(Object theTarget, float theDuration, String thePropertyList) {
        return addAnis(false, theTarget, theDuration, 0.0f, thePropertyList, defaultEasing, defaultTimeMode, theTarget,
                       defaultCallback);
    }
    ...
    public static Ani[] from(Object theTarget, float theDuration, String thePropertyList) {
        return addAnis(true, theTarget, theDuration, 0.0f, thePropertyList, defaultEasing, defaultTimeMode, theTarget,
                       defaultCallback);
    }
    ...
    public static Ani[] to(Object theTarget, float theDuration, float theDelay, String thePropertyList) {
        return addAnis(false, theTarget, theDuration, theDelay, thePropertyList, defaultEasing, defaultTimeMode,
                       theTarget, defaultCallback);
    }
    ...
    public static Ani[] from(Object theTarget, float theDuration, float theDelay, String thePropertyList) {
        return addAnis(true, theTarget, theDuration, theDelay, thePropertyList, defaultEasing, defaultTimeMode,
                       theTarget, defaultCallback);
    }
    ...
    public static Ani[] to(Object theTarget, float theDuration, String thePropertyList, Easing theEasing) {
        return addAnis(false, theTarget, theDuration, 0.0f, thePropertyList, theEasing, defaultTimeMode, theTarget,
                       defaultCallback);
    }
    ...
    public static Ani[] from(Object theTarget, float theDuration, String thePropertyList, Easing theEasing) {
        return addAnis(true, theTarget, theDuration, 0.0f, thePropertyList, theEasing, defaultTimeMode, theTarget,
                       defaultCallback);
    }
    ...
    public static Ani[] to(Object theTarget, float theDuration, float theDelay, String thePropertyList,
                           Easing theEasing) {
        return addAnis(false, theTarget, theDuration, theDelay, thePropertyList, theEasing, defaultTimeMode, theTarget,
                       defaultCallback);
    }
    ...
    public static Ani[] from(Object theTarget, float theDuration, float theDelay, String thePropertyList,
                             Easing theEasing) {
        return addAnis(true, theTarget, theDuration, theDelay, thePropertyList, theEasing, defaultTimeMode, theTarget,
                       defaultCallback);
    }
    ...
    public static Ani[] to(Object theTarget, float theDuration, String thePropertyList, Easing theEasing,
                           Object theCallbackObject, String theCallback) {
        return addAnis(false, theTarget, theDuration, 0.0f, thePropertyList, theEasing, defaultTimeMode,
                       theCallbackObject, theCallback);
    }
    ...
    public static Ani[] from(Object theTarget, float theDuration, String thePropertyList, Easing theEasing,
                             Object theCallbackObject, String theCallback) {
        return addAnis(true, theTarget, theDuration, 0.0f, thePropertyList, theEasing, defaultTimeMode,
                       theCallbackObject, theCallback);
    }
    ...
    public static Ani[] to(Object theTarget, float theDuration, float theDelay, String thePropertyList,
                           Easing theEasing, Object theCallbackObject, String theCallback) {
        return addAnis(false, theTarget, theDuration, theDelay, thePropertyList, theEasing, defaultTimeMode,
                       theCallbackObject, theCallback);
    }
    ...
    public static Ani[] from(Object theTarget, float theDuration, float theDelay, String thePropertyList,
                             Easing theEasing, Object theCallbackObject, String theCallback) {
        return addAnis(true, theTarget, theDuration, theDelay, thePropertyList, theEasing, defaultTimeMode,
                       theCallbackObject, theCallback);
    }

    // create a new Ani instance and add to lookup
    // or overwrite an existing Ani with new parameters
    private static Ani addAni(boolean theReverse, Object theTarget, float theDuration, float theDelay,
                              String theFieldName, float theEnd, Easing theEasing, String theTimeMode,
                              Object theCallbackObject, String theCallback) {
        cleanAnis();
        ...
        // create new Ani
            ...
            Ani newAni = new Ani(theTarget, theDuration, theDelay, theFieldName, theEnd, theEasing, theCallbackObject,
                                 theCallback);
    ...
    // or overwrite an existing Ani with new parameters
    private static Ani[] addAnis(boolean theReverse, Object theTarget, float theDuration, float theDelay,
                                 String thePropertyList, Easing theEasing, String theTimeMode, Object theCallbackObject,
                                 String theCallback) {
        ...
        for (int i = 0; i < propertyList.length; i++) {
            ...
            if (p.length == 2) {
                ...
                tmpAnis[i] = addAni(theReverse, theTarget, theDuration, theDelay, fieldName, end, theEasing,
                                    theTimeMode, theCallbackObject, theCallback);
            }
        }
        return tmpAnis;
    }
