...
//        TextZone textZone = new TextZone("HELLO", 0, 0, 200, 200, false);
        ...
        //PImage deleteImage = ImageLoader.toPImage(image.toString());
        ...
        TextBoxZone tbx = new TextBoxZoneBuilder()
                .setUuid("HELLLLO")
                .setTextString(UUID.randomUUID().toString())
                .setX(5)
                .setY(5)
                .setWidth(300)
                .setHeight(35)
        ...
        String path = Resources.getResource("0.jpg").getPath();
        ...
        PictureZone pictureZone = new PictureZoneBuilder().setPosterItem(pi).createPictureZoneWithPosterItem();
